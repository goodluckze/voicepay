...
public class SendRedBagActivity extends Activity implements SinVoicePlayer.Listener{
    ...
    private String url_sndRedBag = "http://52.80.155.176:8888/redpackets/ReadyRedPackets.aspx";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_snd_redbag_webview);

        mWebView = (WebView)findViewById(R.id.sndredbg_webview);
...
//        mWebView.loadUrl("http://172.16.34.66:86/SendRedPackets.aspx");
        mWebView.loadUrl(url_sndRedBag);
...
//                return super.shouldOverrideUrlLoading(view, request);
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                AlertDialog.Builder b = new AlertDialog.Builder(SendRedBagActivity.this);
                b.setTitle("Alert");
...
/*
    ...
    class JS {
        ...
        public void buildSoud(String p) {
            ...
            mSinVoicePlayer.play(p, true, 1000);
        }
